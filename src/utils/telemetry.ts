 ...
 */
export function trackEvent(name: string, properties?: Record<string, any>, measurements?: Record<string, number>): void {
    if (!telemetryClient) {
        return;
    }
 ...
 */
export function trackTrace(message: string, severity?: number, properties?: Record<string, any>): void {
    if (!telemetryClient) {
 ...
 * Track user activity
 */
export function trackUserActivity(userId: string, activity: string, properties?: Record<string, any>): void {
 ...
 * Track tool usage
 */
export function trackToolUsage(toolName: string, success: boolean, duration: number, properties?: Record<string, any>): void {
 ...
 */
export function trackSecurityEvent(eventType: string, details: Record<string, any>): void {
 ...
 */
export function createConversationContext(conversationId: string, userId: string): Record<string, any> {
    return {
        conversationId,
        userId,
